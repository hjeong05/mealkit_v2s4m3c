   ...
   <!-- <div class="form-group">   
      ...
      <div class="form-group">   
        <div class="col-md-12">
          ...
          <input type='text' class="form-control input-lg" name='title' value='RE:' placeholder="제목" required="required" style='width: 80%;'>
        </div>
      </div>   
      ...
      <DIV class='content_bottom_menu'>
        <button type="submit" class="btn btn-info">답변등록</button>
        <button type="button" 
